...
export default function Tape() {
  ...
  return (
    <div className="py-16 overflow-x-clip -mx-32 max-lg:-mx-24 max-md:-mx-16 max-sm:-mx-8 max-lg:py-12 max-md:py-8 max-sm:py-4">
      <div className="bg-linear-to-r from-btn-primary-hover to-btn-primary dark:from-btn-primary dark:to-btn-primary-hover -rotate-3 -mx-1">
            ...
            {[...new Array(2)].fill(0).map((_, idx) => (
              <Fragment key={idx}>
                {words.map((word) => (
                  ...
                  >
                    <span className="text-secondary dark:text-secondary text-lg uppercase font-extrabold max-md:text-xl max-sm:text-lg">
                      {word}
                    </span>
                    <span>&#9733;</span>
                  </div>
