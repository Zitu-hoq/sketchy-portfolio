...
function Education() {
  ...
  return (
    <div className="my-32">
        <h2 className='font-bold text-8xl mb-32 w-full text-center max-lg:mb-8 max-lg:text-7xl max-md:text-6xl max-sm:text-5xl max-xs:text-4xl'>Educations</h2>
        <div ref={ref} className='w-[75%] mx-auto relative max-md:w-[85%]'>
